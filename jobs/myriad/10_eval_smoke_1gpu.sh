...
POLICY_CHECKPOINT="${POLICY_CHECKPOINT:-${ACTOR_REPLAY_CHECKPOINT_PATH:-${WAN_VA_MODEL_PATH}}}"
REFERENCE_CHECKPOINT="${REFERENCE_CHECKPOINT:-${WAN_VA_MODEL_PATH}}"
RUN_ID="${RUN_ID:-}"
...
export TASK_NAME TEST_NUM PORT MASTER_PORT RESULTS_ROOT SERVER_WAIT_SECONDS ACTOR_REPLAY_CHECKPOINT_PATH
export ACTION_NUM_INFERENCE_STEPS POLICY_CHECKPOINT REFERENCE_CHECKPOINT RUN_ID
export SERVER_HOST PROMPT_INDEX SAMPLING_SEED SAMPLING_SEED_PER_ENV
export SAVE_SERVER_DEBUG_TENSORS SEED
