...
export STRICT_GRPO_CAPTURE STRICT_GRPO_CAPTURE_PY STRICT_GRPO_TRANSITION_STD STRICT_GRPO_CAPTURE_SCOPE STRICT_GRPO_SAVE_REPLAY_CONTEXT
export STRICT_GRPO_CAPTURE_CHUNK_STRIDE STRICT_GRPO_CAPTURE_MAX_CHUNKS SAVE_SERVER_DEBUG_TENSORS
export STRICT_GRPO_REPLAY_CONTEXT_MAX_GB
export ACTION_NUM_INFERENCE_STEPS ACTOR_REPLAY_CHECKPOINT_PATH GROUP_SEED_SEARCH GROUP_SEED_SEARCH_MAX_ATTEMPTS
...
echo "STRICT_GRPO_SAVE_REPLAY_CONTEXT=${STRICT_GRPO_SAVE_REPLAY_CONTEXT}"
echo "STRICT_GRPO_CAPTURE_CHUNK_STRIDE=${STRICT_GRPO_CAPTURE_CHUNK_STRIDE}"
echo "STRICT_GRPO_CAPTURE_MAX_CHUNKS=${STRICT_GRPO_CAPTURE_MAX_CHUNKS}"
echo "STRICT_GRPO_REPLAY_CONTEXT_MAX_GB=${STRICT_GRPO_REPLAY_CONTEXT_MAX_GB}"
...
DOCKER_ARGS=(
    ...
    -e STRICT_GRPO_CAPTURE_SCOPE
    -e STRICT_GRPO_SAVE_REPLAY_CONTEXT
    -e STRICT_GRPO_CAPTURE_CHUNK_STRIDE
    -e STRICT_GRPO_CAPTURE_MAX_CHUNKS
    -e STRICT_GRPO_REPLAY_CONTEXT_MAX_GB
    -e SAVE_SERVER_DEBUG_TENSORS
